module.exports.run = async (bot, message, args) => {
    const embed = {
        ...
        "description": "Mimiron BOT **v1.183**",
        "color": 5560853,
        ...
        "fields": [
          ...
          },
          {
            ...
            "value": "Pour ceux ayant l'envie de regarder le code du bot sur GitHub :\| Il existe à présent un dossier ``commands`` pour alléger le nombre de lignes du fichier principal."
          }
        ]
      };
